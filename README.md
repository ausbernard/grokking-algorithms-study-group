...
This study group is a mix of new and seasoned software engineers learning and reviewing foundational algorithms together. Beginners → Senior engineers welcome.
 *s/o to Aditya*.
...
✔️ Read the `week-00` syllabus

✔️ Set up your coding language environment

✔️ Start the reading on `week-01`
